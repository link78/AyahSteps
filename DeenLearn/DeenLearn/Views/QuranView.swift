    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            if allWords.isEmpty {
                ...
                // Progress
                ProgressView(value: Double(currentWordIndex + 1), total: Double(allWords.count), label: { EmptyView() })
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            if ayahs.isEmpty {
                ...
                // Progress
                ProgressView(value: Double(currentAyahIndex + 1), total: Double(ayahs.count), label: { EmptyView() })
                    .tint(Color(hex: "6B5B95"))
                    .padding(.horizontal)
            }
        }
